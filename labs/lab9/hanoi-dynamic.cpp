...
void initialize(int** towers, int n){
...
void print_array(int** towers, int n){
   for(int i = 0; i < n; i++){
      for(int j = 0; j < 3; j++){
	 cout << towers[i][j] << " ";
      }
...
void move_disk(int** towers, int n, int from_col, int to_col){
...
void tow(int disks, int** towers, int from_col, int to_col, int spare){
   if(disks >= 1){
